...
public class PersonManagementQuery : IQueryPersonManagement
{
    ...
    public async Task<QueryResult<GetMembersResponseDto>> GetMembersByTenantIdAsync(int tenantId, bool onlyWorkers)
    {
        var members = await _personManagementRepo.GetMembersByTenantIdAsync(tenantId, onlyWorkers);
