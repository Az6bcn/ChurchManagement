...
{
    public class UnAssignMemberFromDepartmentCommand: IUnAssignMemberFromDepartment
    {
        ...
        public UnAssignMemberFromDepartmentCommand(IQueryTenant tenantQuery,
        ...
        public async Task ExecuteAsync(AssignMemberToDepartmentRequestDto request)
        {
            ...
            PersonManagementAggregate.UnAssignMemberFromDepartment();
