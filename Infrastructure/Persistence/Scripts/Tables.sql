...
-- Tenants
/****** Object:  Table [dbo].[Tenants]    Script Date: 01/07/2021 15:49:21 ******/
SET ANSI_NULLS ON
GO
...
-- NewComers
/****** Object:  Table [dbo].[NewComers]    Script Date: 01/07/2021 16:00:43 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[NewComers](
	...
	[UpdatedAt] [datetime] NULL,
	[Deleted] [datetime] NULL,
 CONSTRAINT [PK_NewComers] PRIMARY KEY CLUSTERED 
(
	[NewComerId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
-- Ministers
/****** Object:  Table [dbo].[Ministers]    Script Date: 01/07/2021 17:40:23 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Ministers](
	...
	[UpdatedAt] [datetime] NULL,
	[Deleted] [datetime] NULL,
 CONSTRAINT [PK_Ministers] PRIMARY KEY CLUSTERED 
(
	[MinisterId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[Ministers]  WITH CHECK ADD  CONSTRAINT [FK_Ministers_TenantId_Tenant_TenantId] FOREIGN KEY([TenantId])
REFERENCES [dbo].[Tenants] ([TenantId])
GO

ALTER TABLE [dbo].[Ministers] CHECK CONSTRAINT [FK_Ministers_TenantId_Tenant_TenantId]
GO
