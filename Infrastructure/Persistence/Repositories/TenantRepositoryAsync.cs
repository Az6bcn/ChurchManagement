...
namespace Infrastructure.Persistence.Repositories
{
    public class TenantRepositoryAsync: GenericRepositoryAsync<Tenant>, ITenantRepositoryAsync
    {
        ...
        public async Task<Tenant?> GetMonthDashboardDataAsync(Guid tenantGuidId, int tenantId)
        {
            ...
            var response =  await _dbContext.Tenants
                ...
                // .AsSplitQuery()
                .SingleOrDefaultAsync(t => t.TenantId == tenantId && t.TenantGuidId == tenantGuidId); 
